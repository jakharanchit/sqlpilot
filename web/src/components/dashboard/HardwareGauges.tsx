...
function GaugeCard({
  ...
  const data = [{ name: label, value: fillPct, fill: color }];
  ...
  return (
    ...
    >
      ...
      {critical && (
        ...
        >
          VRAM nearly full — optimization
          <br />
          may slow or switch to CPU
        </div>
      )}
    </div>
  );
    ...
    >
      ...
      <GaugeCard
        ...
        footer={[
          ...
          {
            label: "RAM free",
            value: `${((stats.ram_total_mb - stats.ram_usage_mb) / 1024).toFixed(1)} GB`,
          },
          ...
          footer={
            vramCrit
              ...
              : [
                  ...
                  {
                    label: "Source",
                    value: stats.gpu.source === "pynvml" ? "nvml" : "smi",
                  },
                ]
          }
        />
